...
import { currencies, exchangeRates, settings, materials, products, billOfMaterials, intermediateMaterialBom, materialPriceHistory, priceLevels, priceLevelItems, customers, priceLists, priceListItems, activityLog } from './schema';
...
app.post('/api/products/bulk-approve', async (req, res) => {
    try {
        const { productIds, priceMethod, markupPercentage, priceExpiryDate } = req.body;

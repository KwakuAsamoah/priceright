...
export default function Dashboard() {
  ...
  async function downloadSetupGuide() {
    ...
    const content = `
      <p>Simple setup instructions for first-time users</p>
      <p>PriceRight helps you cost products accurately, approve base prices, and manage customer pricing in one place.</p>
      <ol>${pointsHtml}</ol>
      <p>Downloading sample data is optional. If you want to explore first, go to Settings and download the bundled sample files.</p>
    `;
    try {
      await generateArticlePDF({
        title: 'PriceRight Setup Guide',
        content,
        filename: 'priceright-setup-guide.pdf',
      });
    } catch (error) {
      console.error('Failed to download setup guide PDF', error);
    }
  }
        ...
        {isNewInstallation && !bannerDismissed && (
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              ...
              <button className="btn btn-secondary" onClick={() => void downloadSetupGuide()}>
        ...
        <div className="dashboard-chart-grid">
          ...
          <div className="app-card dashboard-chart-card" style={{ padding: '18px' }}>
            ...
            <button
              ...
              onClick={() => navigate('/reports?hub=pricing-health&view=markup-analysis')}
            >
